public class BankApplication {
    public static void main(String[] args) {
        ...
        BankAccount currentStudentOnlineAccount = new Online(new Student(new CurrentAccount(grace, 1234, 10000.00)));

        //Savings, Personal, Graduate Account
        BankAccount savingsPersonalGraduateAccount = new Graduate(new Personal(new SavingsAccount(grace, 1234, 1000.00)));
